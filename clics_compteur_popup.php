			...
			:
				...
				:
					if(isset($_POST['pub_id_hash'])):
						...
						$javascript .= '<script type="text/javascript">' . FP_LIGNE;		
						$javascript .= 'var pub_id = '. intval($_GET['pub_id']) .';' . FP_LIGNE;		
						$javascript .= 'var compteur = '. $compteur .';</script>' . FP_LIGNE;		
						$javascript .= '<script type="text/javascript" src="html/javascripts/decompte_popup.js"></script>'. FP_LIGNE;
